/**
 * Synthesis Utilities
 * Context hash computation and directive prompt building
 * COPIED FROM: src/domains/conversation-engine/constants/synthesis.utils.ts
 */

import crypto from "crypto";

import type { InnuoraAnalysis, RelationalTrace, SessionDynamicsMatrix } from "./types";
...
/**
 * Build contextual synthesis prompt for GPT-4o-mini
 */
