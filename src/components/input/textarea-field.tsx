        ...
        <FormItem>
          ...
          <FormControl>
            <textarea
              ...
              {...field}
              className={
                "w-full rounded-2xl border min-h-[100px] max-h-[160px] border-border bg-secondary px-4 py-3 ltr:pr-12 rtl:pl-12 text-primary placeholder:text-muted-foreground outline-none transition focus:border-primary focus:ring-2 focus:ring-primary focus:ring-opacity-20 disabled:opacity-70 disabled:cursor-not-allowed"
              }
            />
          </FormControl>
