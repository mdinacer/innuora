        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4  rounded-lg">
            <div>
              ...
              <p className="text-sm ">Receive important updates and reminders via email</p>
            </div>
            <button
              onClick={() => setEmailNotifications(!emailNotifications)}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                emailNotifications ? "bg-blue-600" : ""
              }`}
            >
              <span
            ...
            <div className="ml-4 space-y-3">
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs ">Gentle reminders to continue your journey</p>
                  </div>
                </div>
                <button
                  onClick={() => setSessionReminders(!sessionReminders)}
                  className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${
                    sessionReminders ? "bg-blue-600" : ""
                  }`}
                >
                  <span
              ...
              <div className="flex items-center justify-between p-3  border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs ">Important security and account updates</p>
                  </div>
                </div>
                <button
                  onClick={() => setSecurityAlerts(!securityAlerts)}
                  className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${
                    securityAlerts ? "bg-blue-600" : ""
                  }`}
                >
                  <span
                    className={`inline-block h-3 w-3 transform rounded-full  transition-transform ${
              ...
              <div className="flex items-center justify-between p-3  border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h5 className="font-medium ">Product Updates</h5>
                    <p className="text-xs ">New features and improvements</p>
                  </div>
                </div>
                <button
                  onClick={() => setProductUpdates(!productUpdates)}
                  className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${
                    productUpdates ? "bg-blue-600" : ""
                  }`}
                >
                  <span
                    className={`inline-block h-3 w-3 transform rounded-full  transition-transform ${
          ...
          <div className="flex items-center justify-between p-4  rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm ">Play sounds for notifications and interactions</p>
              </div>
            </div>
            <button
              onClick={() => setSoundEnabled(!soundEnabled)}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                soundEnabled ? "bg-blue-600" : ""
              }`}
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full  transition-transform ${
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4  rounded-lg">
            <div>
              ...
              <p className="text-sm ">Reduce notifications during specified hours</p>
            </div>
            <button
              onClick={() => setQuietHours(!quietHours)}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                quietHours ? "bg-blue-600" : ""
              }`}
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full  transition-transform ${
        ...
        <div className=" rounded-md border p-4 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm ">Your wellbeing check-in is ready. Take a moment for yourself today.</p>
            </div>
          </div>
        </div>
      </div>
