          ...
          <div className="rounded-xl border border-green-500/30 bg-green-500/10 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-2">{endToEndEncryption?.description}</p>
          ...
          <div className="rounded-xl border border-green-500/30 bg-green-500/10 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{zeroKnowledge?.description}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-primary/30 bg-muted p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-2">{cloud.card.description}</p>
        ...
        <div className="rounded-xl border border-border bg-muted p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{retention.card.description}</p>
            </div>
          </div>
        </div>
      </div>
