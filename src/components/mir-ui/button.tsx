...
const buttonVariants = cva(
  "inline-flex items-center gap-2 rounded-xl font-medium transition focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        primary: "bg-mir-bg-accent text-white shadow hover:translate-y-[-1px] hover:shadow-lg",
        secondary: "hover:bg-mir-bg-input text-mir-text-primary",
        outline: "border border-mir-border-light hover:bg-mir-bg-input",
        destructive:
        ...
        ghost: "hover:bg-mir-bg-input text-mir-text-secondary",
      },
      size: {
