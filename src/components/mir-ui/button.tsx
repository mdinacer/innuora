...
const buttonVariants = cva(
  "inline-flex items-center gap-2 rounded-xl font-medium transition focus:outline-none focus:ring-0 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
