    ...
    <div className={cn("", className)}>
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <div className="text-center mb-8">
          <div className="floating-heart w-12 h-12 mx-auto mb-4 rounded-full bg-inn-bg-accent flex items-center justify-center">
            <svg width="24" height="24" fill="white" viewBox="0 0 24 24">
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
            </svg>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-3">Your inner world, reflected</h1>
          <p className="text-lg text-inn-text-secondary max-w-2xl mx-auto">
            Based on our conversations, here are some gentle insights about the patterns in your thoughts and feelings.
          </p>
        </div>

        <div className="bg-inn-bg-card rounded-2xl p-6 shadow-[0_4px_20px] shadow-inn-bg-accent/15 border border-inn-border-light">
          <p className="text-inn-text-secondary text-sm text-center italic">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-12">
        <div className="bg-gradient-to-br from-inn-bg-card to-inn-bg-soft border border-inn-border-light rounded-2xl p-8 shadow-[0_4px_20px] shadow-inn-bg-accent/15">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-inn-bg-accent flex items-center justify-center">
          ...
          <div className="space-y-6">
            {diagnostics.whats_happening.map((item, index) => (
              <div
                key={index}
                className="rounded-xl bg-inn-bg-soft p-5 flex flex-col gap-y-2 items-start border-l-4 border-inn-bg-accent"
              >
                <Badge
                  className="uppercase"
      ...
      <section className="max-w-6xl mx-auto px-6 pb-12">
        <div className="bg-gradient-to-br from-inn-bg-card to-inn-bg-soft border border-inn-border-light rounded-2xl p-8 shadow-[0_4px_20px] shadow-inn-bg-accent/15">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-inn-bg-flame flex items-center justify-center">
              <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
          ...
          <div className="grid gap-4 md:grid-cols-1">
            {diagnostics.hidden_rules.map((item, index) => (
              <div
                key={index}
                className="bg-gradient-to-r from-inn-bg-flame/10  border-l-inn-bg-flame rounded-xl p-5 border-l-4 rigidity-rigid"
              >
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-2 h-2 rounded-full bg-inn-bg-flame"></div>
                  <h3 className="font-semibold text-inn-text-primary">{item.rule}</h3>
                </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-12">
        <div className="bg-gradient-to-br from-inn-bg-card to-inn-bg-soft border border-inn-border-light rounded-2xl p-8 shadow-[0_4px_20px] shadow-inn-bg-accent/15">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-inn-text-warm flex items-center justify-center">
              <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
            {diagnostics.why_heavy.map((item, index) => (
              <div key={index} className="rounded-xl bg-inn-bg-soft p-6 border border-inn-border-light">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="font-semibold text-inn-text-primary flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-inn-text-warm"></div>
                    {item.title.replace("–", " - ")}
                  </h3>
                  <Badge
                    className="uppercase"
      ...
      <section className="max-w-6xl mx-auto px-6 pb-12">
        <div className="bg-gradient-to-r from-inn-bg-success/10 border-l-4 border-l-inn-bg-success to-transparent rounded-2xl p-8 shadow-[0_4px_20px] shadow-inn-bg-accent/15">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-inn-bg-success flex items-center justify-center">
              <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16">
        <div className="rounded-2xl p-8 shadow-[0_8px_30px] shadow-inn-bg-accent/25 text-white bg-gradient-to-br from-inn-bg-accent to-inn-bg-accent-dark">
          <div className="flex items-center gap-3 mb-6">
          ...
          <div className="grid gap-4 md:grid-cols-1">
            {diagnostics.where_to_start.map((item, index) => (
              <div key={index} className="bg-inn-bg-accent-dark rounded-xl p-5 backdrop-blur-sm difficulty-gentle">
        ...
        <div className="bg-gradient-to-br from-inn-bg-card to-inn-bg-soft border border-inn-border-light rounded-2xl p-8 shadow-[0_4px_20px] shadow-inn-bg-accent/15">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {diagnostics.relevant_resources.map((item, index) => (
              <div
                key={index}
                className="rounded-xl flex flex-col items-start bg-inn-bg-soft p-5 border border-inn-border-light"
              >
                <div className="flex items-center gap-2 mb-3">
                  <h3 className="font-semibold text-inn-text-primary capitalize">{item.category}</h3>
                </div>
                <div className="flex-1">
                  <p className="text-sm text-inn-text-secondary mb-3 first-letter:capitalize">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-12">
        <div className="bg-inn-bg-card rounded-2xl p-6 shadow-[0_4px_20px] shadow-inn-bg-accent/15 border border-inn-border-light text-center">
          <div className="w-8 h-8 mx-auto mb-3 rounded-full bg-inn-bg-success flex items-center justify-center">
            <svg width="16" height="16" fill="white" viewBox="0 0 24 24">
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
            </svg>
          </div>
          <h3 className="font-semibold text-inn-text-primary mb-2">A gentle reminder</h3>
          <p className="text-inn-text-secondary text-sm max-w-2xl mx-auto">
