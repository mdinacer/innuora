...
const FlowChatHeroCard = (props: Props) => {
  ...
  return (
    <div
      className={cn(
        "hero-card z-10",
        " bg-card rounded-3xl py-8 px-7 mb-6 relative overflow-hidden shrink-0",
    ...
    >
      <div
        className={cn(
          ...
          "bg-primary rounded-full opacity-10",
      ...
      <div className={cn("hero-content", "relative z-[2]")}>
        <h2 className={cn("hero-title", "text-2xl font-bold text-foreground leading-[1.2] -tracking-[0.5px] mb-3")}>
          {title}
        </h2>
        <p className={cn("hero-subtitle", "text-base text-foreground/70 leading-[1.5] mb-5 ")}>{subtitle}</p>
