  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-inn-border-light bg-inn-bg-card p-6 shadow-[0_2px_8px] shadow-inn-bg-accent/10">
        ...
        <Link
          href="#"
          className="inline-flex rounded-2xl border border-inn-border-light px-5 py-2.5 font-semibold text-[var(--text-primary)] hover:text-inn-bg-accent hover:border-inn-bg-accent transition"
        >
          Contact Support
        </Link>
      </div>
