  ...
  return (
    <section id="demo" className="max-w-4xl mx-auto px-6 py-16">
      <div className="text-center mb-10">
        ...
        <p className="text-[17px] text-mir-text-secondary max-w-2xl mx-auto">
      ...
      <div className="rounded-2xl border border-mir-border-light bg-mir-bg-card p-6 shadow-card space-y-4">
        <div className="flex justify-end">
          <div className="max-w-[80%] rounded-2xl border border-mir-border-light bg-mir-bg-input px-4 py-3 text-sm">
            I feel stuck and weighed down by everything.
          </div>
        </div>
        <div className="flex justify-start">
          <div className="max-w-[80%] rounded-2xl bg-mir-bg-accent px-4 py-3 text-sm text-white">
