    ...
    <section className="max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {MIRAEL_FEATURES.map((feature, index) => (
          <div key={index} className="rounded-2xl border border-inn-border-light bg-inn-bg-card p-6 shadow-subtle">
        ...
        <div className="rounded-2xl border border-border-inn-border-light bg-inn-bg-card p-6 shadow-subtle">
