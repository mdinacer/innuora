  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16 text-center">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-3 mb-5">
        ...
        <a
          href="#demo"
          className="inline-flex justify-center rounded-2xl border border-inn-border-light bg-transparent px-6 py-3 font-semibold text-inn-text-primary hover:text-inn-bg-accent hover:border-inn-bg-accent transition"
        >
          See a conversation
        </a>
      </div>
