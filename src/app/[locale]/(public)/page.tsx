    ...
    <main className="relative font-sans rtl:font-arabic-body rtl:text-lg min-h-screen pt-20 w-screen standalone:w-full overflow-hidden bg-background transition-all duration-300 ease-in text-foreground">
      <section className="relative max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
          <Link
            ...
            className="inline-flex justify-center rounded-2xl border border-border bg-transparent rtl:pt-4 px-8 py-4 text-lg font-semibold text-foreground hover:text-primary hover:border-primary transition-all"
          >
            Sign In
          </Link>
          <Link
            href={`/${locale}/auth/sign-up`}
            className="inline-flex justify-center rtl:pt-4 rounded-2xl bg-primary px-8 py-4 text-lg text-white font-semibold shadow hover:translate-y-[-1px] transition"
          >
            Create Account
          </Link>
        </div>
      ...
      <section className="relative max-w-3xl mx-auto px-6 pb-24">
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-border bg-card p-6 shadow-[0_2px_8px] shadow-black/5 text-center">
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-[0_2px_8px] shadow-black/5 text-center">
            ...
            <p className="text-sm text-muted-foreground">Emotionally attuned conversations</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-6 shadow-[0_2px_8px] shadow-black/5 text-center">
            <div className="text-3xl mb-3">📊</div>
            <h3 className="text-lg font-semibold mb-2">Track Progress</h3>
            <p className="text-sm text-muted-foreground">See patterns and insights over time</p>
          </div>
        </div>
      </section>
    </main>
