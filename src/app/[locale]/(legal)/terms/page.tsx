  ...
  return (
    <main className="relative font-sans min-h-screen pt-20 w-screen overflow-hidden bg-mir-bg-primary transition-all duration-300 ease-in text-mir-text-primary">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight tracking-tight mb-4">Terms of Use</h1>
        <p className="text-lg md:text-xl text-mir-text-secondary max-w-2xl mx-auto mb-6">
          These terms govern your use of Mirael's emotional reflection and clarity tools. By using our service, you
      ...
      <section className="max-w-4xl mx-auto px-6 pb-12">
        <div className="rounded-2xl p-8 text-center text-white bg-gradient-to-b from-mir-bg-accent to-mir-bg-accent-dark">
          <h2 className="text-2xl font-bold mb-3">Important Agreement</h2>
          <p className="mb-4 opacity-90">
            By accessing or using Mirael, you agree to be bound by these Terms of Use. If you do not agree with these
            terms, you may not use our service.
          </p>
          <p className="text-sm opacity-80">Please read these terms carefully before using Mirael.</p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        ...
        <section className="mb-12">
          <div className="rounded-2xl p-8 text-center text-white bg-gradient-to-b from-mir-bg-accent to-mir-bg-accent-dark">
            ...
            <div className="p-4 rounded-xl bg-black/10 mt-4">
