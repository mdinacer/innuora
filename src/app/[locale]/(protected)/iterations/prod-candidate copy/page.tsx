...
import CrisisConfirmationDialog from "@/components/crisis/crisis-confirmation-dialog";
...
export default function Page() {
  ...
  const wellnessChecks = useConversationStore((state) => state.wellnessChecks);
  ...
  return (
    <main className="relative h-screen w-screen bg-background">
      <div className="absolute top-6 left-6">
        <CodeView data={{ messages, rounds, wellnessChecks, tokenTelemetry }} />
      </div>
