    ...
    schema: {
      ...
      properties: {
        ...
        signals: {
          ...
          properties: {
            resistance: {
              type: "string",
              enum: ["none", "sarcasm", "dismissive", "intellectualized"],
              description: "Pick the closest resistance signal observed in her message.",
            },
            crisis: {
              type: "string",
              enum: ["none", "acute"],
              description: "Set to acute only when she signals present self-harm risk.",
            },
          },
          required: ["resistance", "crisis"],
        },
        ...
        next_relational_trace: {
          ...
          required: ["relational_stance", "tone", "focus", "notes", "used_lived_line", "user_engagement"],
        },
