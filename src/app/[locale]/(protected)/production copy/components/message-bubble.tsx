...
import { Psychoeducation } from "../domains/reflection/types";
              ...
              <div className="flex sm:flex-row flex-col gap-4 mt-3 sm:items-center sm:justify-end w-full">
                {message.psychoeducation && (
                  ...
                  >
                    ...
                    <span className="text-inherit">{`Learn about ${message.psychoeducation.subject}`}</span>
                  </button>
                )}
                {message.next_action && (
                  <button
                  ...
                  >
                    ...
                    {/* <span className="pill-icon">✨</span> */}
                    <span>{message.next_action.label}</span>
                  </button>
                )}
              </div>
            )}
