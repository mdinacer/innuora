...
import CORE_MODULE_INSTRUCTIONS from "./modules.core";
import PROCESS_MODULE_INSTRUCTIONS from "./modules.process";
import UTILITY_MODULE_INSTRUCTIONS from "./modules.utility";
