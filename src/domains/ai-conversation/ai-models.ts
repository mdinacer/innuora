...
// // Used for main therapeutic conversations
// //────────────────────────────────────────────
// export const AI_MODEL_CONFIG: ModelConfig = {
//   name: (process.env.AI_MODEL_NAME || "gpt-4o") as ChatModel,
//   vendor: "openai",
//   inputPricePer1K: num(process.env.AI_MODEL_PRICE_INPUT_PER_1K, 0.0025), // $2.50/M input tokens
//   cachedInputPricePer1K: num(process.env.AI_MODEL_PRICE_CACHED_INPUT_PER_1K, 0.00125), // $1.25/M cached input tokens
//   outputPricePer1K: num(process.env.AI_MODEL_PRICE_OUTPUT_PER_1K, 0.01), // $10/M output tokens
//   maxOutput: num(process.env.AI_MODEL_MAX_OUTPUT, 4096),
// };

// //────────────────────────────────────────────
// // FALLBACK MODEL — GPT-4.1
// // Alternative model for analysis or diagnostics
// //────────────────────────────────────────────
// export const AI_FALLBACK_MODEL_CONFIG: ModelConfig = {
//   name: (process.env.AI_FALLBACK_MODEL_NAME || "gpt-4.1") as ChatModel,
//   vendor: "openai",
//   inputPricePer1K: num(process.env.AI_FALLBACK_MODEL_PRICE_INPUT_PER_1K, 0.002), // $2.00/M input tokens
//   cachedInputPricePer1K: num(process.env.AI_FALLBACK_MODEL_PRICE_CACHED_INPUT_PER_1K, 0.001), // $1.00/M cached input tokens
//   outputPricePer1K: num(process.env.AI_FALLBACK_MODEL_PRICE_OUTPUT_PER_1K, 0.008), // $8.00/M output tokens
//   maxOutput: num(process.env.AI_FALLBACK_MODEL_MAX_OUTPUT, 4096),
// };

// //────────────────────────────────────────────
// // MINI MODEL — GPT-4.1-mini (Cost-effective)
// // Used for non-critical background tasks (titles, summaries, categorization)
// //────────────────────────────────────────────
// export const AI_MINI_MODEL_CONFIG: ModelConfig = {
//   name: (process.env.AI_MINI_MODEL_NAME || "gpt-4.1-mini") as ChatModel,
//   vendor: "openai",
//   inputPricePer1K: num(process.env.AI_MINI_MODEL_PRICE_INPUT_PER_1K, 0.0004), // $0.40/M input tokens
//   cachedInputPricePer1K: num(process.env.AI_MINI_MODEL_PRICE_CACHED_INPUT_PER_1K, 0.0002), // $0.20/M cached input tokens
//   outputPricePer1K: num(process.env.AI_MINI_MODEL_PRICE_OUTPUT_PER_1K, 0.0016), // $1.60/M output tokens
//   maxOutput: num(process.env.AI_MINI_MODEL_MAX_OUTPUT, 2048),
// };

// export const AI_MICRO_MODEL_CONFIG: ModelConfig = {
//   name: (process.env.AI_MICRO_MODEL_NAME || "gpt-4o-mini") as ChatModel,
//   vendor: "openai",
//   inputPricePer1K: num(process.env.AI_MICRO_MODEL_PRICE_INPUT_PER_1K, 0.00015), // $0.15/M input tokens
//   cachedInputPricePer1K: num(process.env.AI_MICRO_MODEL_PRICE_CACHED_INPUT_PER_1K, 0.000075), // $0.075/M cached input tokens
//   outputPricePer1K: num(process.env.AI_MICRO_MODEL_PRICE_OUTPUT_PER_1K, 0.0006), // $0.60/M output tokens
//   maxOutput: num(process.env.AI_MICRO_MODEL_MAX_OUTPUT, 2048),
// };

//────────────────────────────────────────────
// REFLECTION MODEL — GPT-4o (Primary Engine)
// Used for main therapeutic conversations
//────────────────────────────────────────────
