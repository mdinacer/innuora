...
import { SESSION_PHASE_EVALUATION_PROMPT } from "./phase-evaluation.prompts";
import { SessionPhaseEvaluation, SessionPhaseEvaluationSchema } from "./phase-evaluation.types";
import { buildSessionPhaseEvaluationInput } from "./phase-evaluation.utils";

export async function evaluateSessionPhase(sessionId: string, userMessages: ChatMessage[], messagesWindowSize = 8) {
