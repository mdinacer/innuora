...
import { DEFAULT_REFLECTION_DIRECTIVE, ReflectionDirective } from "../reflection-directive/types";
...
export type CrisisState = "none" | "active" | "resolved";
...
export const useConversationStore = create<ConversationStoreState>((set) => ({
  ...
  setCrisisConfirmation: (confirmed) => set({ crisisConfirmation: confirmed }),
